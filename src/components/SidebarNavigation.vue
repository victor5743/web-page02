	...
	<div>
		<Slide>
			...
			<a href="#">
				...
				<span class="hover:text-white">Search</span>
			</a>
			<!-- Home -->
			<a href="#">
				<svg fill="currentColor" viewBox="0 0 24 24" width="24" height="24">
			...
			<a href="#">
				...
				<span class="hover:text-white">Watchlist</span>
			</a>
			<!-- Movies -->
			<a href="#">
				...
				<span class="hover:text-white">Movies</span>
			</a>
			<!-- Series -->
			<a href="#">
				...
				<span class="hover:text-white">Series</span>
			</a>
			<!-- Originals -->
			<a href="#">
				<svg fill="currentColor" width="24" height="24" viewBox="0 0 24 24">
				...
				<span class="hover:text-white">Originals</span>
			</a>
			<!-- Settings -->
			<a href="#">
				<svg
				...
				<span class="hover:text-white">Settings</span>
			</a>
			<!-- Logo -->
			<a class="ml-8" href="#">
				<img src="@/assets/disneyplus_logo.svg" alt="Disney Logo" />
			</a>
		</Slide>
	</div>
</template>
